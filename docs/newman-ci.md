...
```
[HEPHAESTUS_CI] {"v":"4.0.0","request":"Получение токена","method":"GET","status":200,"time":142,"size":1024,"format":"xml","found":[],"saved":["prod.token"],"counts":[],"headers":[{"name":"Content-Type","ok":true}],"snapshot":null,"schema":null,"errors":[]}
```
