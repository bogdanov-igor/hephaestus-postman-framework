...
const COMMANDS = {
    ...
    report:  { script: 'generate-report.js', usage: 'report <results.json> [out.html] [--history [f]]', about: 'Self-contained HTML report' },
    ...
    openapi: { script: 'openapi-import.js',  usage: 'openapi <spec.yaml|json> [-o out.json] [--negative]', about: 'OpenAPI/Swagger → collection; --negative adds error-path tests' },
    ...
    init:    { script: 'init.js',            usage: 'init [--defaults] [--demo [dir]]',                  about: 'Config wizard; --demo scaffolds a runnable offline demo' },
